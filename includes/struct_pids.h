...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/11/24 02:53:21 by rreedy            #+#    #+#             */
...
int		realloc_pids_array(struct *s_path_ids, size_t new_min_size);
int		add_pid(struct *s_path_ids, size_t index, size_t bit);
